 ...
 */
final class Version20200125121610 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD user_id INT NOT NULL, ADD subject_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comments DROP user_id, DROP subject_id');
        $this->addSql('ALTER TABLE subjects CHANGE user_id user_id INT DEFAULT NULL');
    }
}
